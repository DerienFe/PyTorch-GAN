...
parser.add_argument("--sample_interval", type=int, default=250, help="interval between image sampling")
...
"""
transform = transforms.Compose([transforms.RandomResizedCrop(opt.img_size, scale=(0.95, 1.0)),
...
"""
transformed_self_dataset = Self_dataset(PATH = '../gan/cat_images/', transform = transform)
...
for epoch in range(opt.n_epochs):
    for i, imgs in enumerate(dataloader):
        ...
        if batches_done % opt.sample_interval == 0:
            ...
            g_save_path = './models/generator_model_{0}.pth'.format(epoch)
